...
export const metadata: Metadata = {
  ...
  description: "Explore the August Catering menu. From traditional Kerala Sadhya and Biryani to Continental, Chinese, and bespoke fusion dishes for your events.",
  openGraph: {
    title: "Culinary Menu | August Catering Caterers",
